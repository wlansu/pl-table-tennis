...
!function (a) {
    ...
    "use strict";
    var d = b.UIkit || {}, e = b("html"), f = b(window);
    ...
    "use strict";
    var c = a(window), d = "resize orientationchange", e = [], f = function (g, h) {
        var i = this, j = a(g);
    ...
    a.extend(f.prototype, {process: function () {
        var b = this;
        this.revert();
    ...
    }}), f.defaults = {cls: "uk-margin-small-top"}, b.stackMargin = f, a(document).on("uk-domready", function () {
    ...
    a.extend(c.prototype, {close: function () {
        function a() {
    ...
    }}), c.defaults = {fade: !0, duration: 200, trigger: ".uk-alert-close"}, b.alert = c, a(document).on("click.alert.uikit", "[data-uk-alert]", function (d) {
        var e = a(this);
        if (!e.data("alert")) {
    ...
    a.extend(c.prototype, {getSelected: function () {
        this.element.find(".uk-active")
    }}), c.defaults = {target: ".uk-button"};
    var d = function (b, c) {
        var e = a(b);
    ...
    a.extend(d.prototype, {getSelected: function () {
        this.element.find(".uk-active")
    }}), d.defaults = {target: ".uk-button"};
    var e = function (b, c) {
        var d = this, f = a(b);
    ...
    a.extend(e.prototype, {options: {}, toggle: function () {
    ...
    a.extend(d.prototype, {remainIdle: !1, show: function () {
    ...
    }}), d.defaults = {mode: "hover", remaintime: 800, justify: !1, boundary: a(window)}, b.dropdown = d;
    ...
    a.extend(f.prototype, {match: function () {
        this.revert();
    ...
    g.defaults = {cls: "uk-grid-margin"}, b.gridMatchHeight = f, b.gridMargin = g, a(document).on("uk-domready", function () {
    ...
    var e = !1, f = a("html"), g = function (c, d) {
        var e = this;
    ...
    a.extend(g.prototype, {scrollable: !1, transition: !1, toggle: function () {
        ...
        if (this.scrollbarwidth = window.innerWidth - f.width(), f.css(a, this.scrollbarwidth), this.element.css(a, ""), this.dialog.offset().left > this.scrollbarwidth && this.element.css(a, this.scrollbarwidth - (this.element[0].scrollHeight == window.innerHeight ? 0 : this.scrollbarwidth)), this.scrollable) {
            ...
            var c = Math.abs(parseInt(this.dialog.css("margin-top"), 10)), d = this.dialog.outerHeight(), e = window.innerHeight, g = e - 2 * (20 > c ? 20 : c) - d;
        ...
        return e == this
    }}), g.dialog = {tpl: '<div class="uk-modal"><div class="uk-modal-dialog"></div></div>'}, g.defaults = {keyboard: !0, show: !1, bgclose: !0, minScrollHeight: 150};
    var h = function (b, c) {
        var d = this, e = a(b);
        e.data("modal") || (this.options = a.extend({target: e.is("a") ? e.attr("href") : !1}, c), this.element = e, this.modal = new g(this.options.target, c), e.on("click", function (a) {
    ...
    h.dialog = function (b, c) {
        ...
        h.dialog(['<div class="uk-margin uk-modal-content">' + String(b) + "</div>", '<div class="uk-modal-buttons"><button class="uk-button uk-button-primary uk-modal-close">Ok</button></div>'].join(""), a.extend({bgclose: !1, keyboard: !1}, c)).show()
    }, h.confirm = function (b, c, d) {
        c = a.isFunction(c) ? c : function () {
        };
        var e = h.dialog(['<div class="uk-margin uk-modal-content">' + String(b) + "</div>", '<div class="uk-modal-buttons"><button class="uk-button uk-button-primary js-modal-confirm">Ok</button> <button class="uk-button uk-modal-close">Cancel</button></div>'].join(""), a.extend({bgclose: !1, keyboard: !1}, d));
    ...
    "use strict";
    var c, d = a(window), e = a(document), f = {show: function (b) {
        if (b = a(b), b.length) {
            ...
            c = {x: window.scrollX, y: window.scrollY}, b.addClass("uk-active"), g.css({width: window.innerWidth, height: window.innerHeight}).addClass("uk-offcanvas-page"), g.css(i ? "margin-right" : "margin-left", (i ? -1 : 1) * (h.outerWidth() - k) * j).width(), h.addClass("uk-offcanvas-bar-show").width(), b.off(".ukoffcanvas").on("click.ukoffcanvas swipeRight.ukoffcanvas swipeLeft.ukoffcanvas", function (b) {
                var c = a(b.target);
        ...
        var d = this, e = a(b);
        e.data("offcanvas") || (this.options = a.extend({target: e.is("a") ? e.attr("href") : !1}, c), this.element = e, e.on("click", function (a) {
    ...
    a.extend(d.prototype, {open: function (b, d) {
    ...
    }}), d.defaults = {toggle: ">li.uk-parent > a[href='#']", lists: ">li.uk-parent > ul", multiple: !1}, b.nav = d, a(document).on("uk-domready", function () {
    ...
    var d, e, f = function (b, c) {
        var d = this, e = a(b);
        e.data("tooltip") || (this.options = a.extend({}, f.defaults, c), this.element = e.on({focus: function () {
            d.show()
        }, blur: function () {
            d.hide()
        }, mouseenter: function () {
    ...
    a.extend(f.prototype, {tip: "", show: function () {
        if (e && clearTimeout(e), this.tip.length) {
            ...
            var b = this, c = a.extend({}, this.element.offset(), {width: this.element[0].offsetWidth, height: this.element[0].offsetHeight}), f = d[0].offsetWidth, g = d[0].offsetHeight, h = "function" == typeof this.options.offset ? this.options.offset.call(this.element) : this.options.offset, i = "function" == typeof this.options.pos ? this.options.pos.call(this.element) : this.options.pos, j = {display: "none", visibility: "visible", top: c.top + c.height + g, left: c.left}, k = i.split("-");
            "left" != k[0] && "right" != k[0] || "right" != a.UIkit.langdirection || (k[0] = "left" == k[0] ? "right" : "left");
            var l = {bottom: {top: c.top + c.height + h, left: c.left + c.width / 2 - f / 2}, top: {top: c.top - g - h, left: c.left + c.width / 2 - f / 2}, left: {top: c.top + c.height / 2 - g / 2, left: c.left - f - h}, right: {top: c.top + c.height / 2 - g / 2, left: c.left + c.width + h}};
            ...
            j.left -= a("body").position().left, e = setTimeout(function () {
                d.css(j).attr("class", "uk-tooltip uk-tooltip-" + i), b.options.animation ? d.css({opacity: 0, display: "block"}).animate({opacity: 1}, parseInt(b.options.animation, 10) || 400) : d.show(), e = !1
    ...
    }}), f.defaults = {offset: 5, pos: "top", animation: !1, delay: 0, src: function () {
    ...
    }}), c.defaults = {connect: !1, toggle: ">*", active: 0}, b.switcher = c, a(document).on("uk-domready", function () {
    ...
    var c = function (b, d) {
        ...
        if (!f.data("tab")) {
            ...
            }), this.element.uk("switcher", {toggle: ">li:not(.uk-tab-responsive)", connect: this.options.connect, active: this.options.active}), h.append(j).uk("dropdown", {mode: "click"}), this.element.append(h).data({dropdown: h.data("dropdown"), mobilecaption: i}).on("uk.switcher.show", function (a, b) {
                h.addClass("uk-active"), i.html(b.find("a").text())
            }), this.element.data("tab", this)
        }
    };
    c.defaults = {connect: !1, active: 0}, b.tab = c, a(document).on("uk-domready", function () {
    ...
    f.defaults = {cls: "uk-scrollspy-inview", initcls: "uk-scrollspy-init-inview", topoffset: 0, leftoffset: 0, repeat: !1, delay: 0}, b.scrollspy = f;
    var g = [], h = function () {
    ...
    i.defaults = {cls: "uk-active", closest: !1, topoffset: 0, leftoffset: 0, smoothscroll: !1}, b.scrollspynav = i;
    var j = function () {
        e(), h()
    };
    ...
    var c = function (b, d) {
        ...
        f.data("smoothScroll") || (this.options = a.extend({}, c.defaults, d), this.element = f.on("click", function () {
            ...
            return c + f > d && (c = d - f), a("html,body").stop().animate({scrollTop: c}, e.options.duration, e.options.transition), !1
        }), this.element.data("smoothScroll", this))
    };
    c.defaults = {duration: 1e3, transition: "easeOutExpo", offset: 0}, b.smoothScroll = c, a.easing.easeOutExpo || (a.easing.easeOutExpo = function (a, b, c, d, e) {
    ...
    b.extend(d.prototype, {toggle: function () {
    ...
    }}), d.defaults = {target: !1, cls: "uk-hidden"}, c.toggle = d, b(document).on("uk-domready", function () {
